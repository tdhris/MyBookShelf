...
urlpatterns = patterns('',
                       ...
                       url(r'^bookshelf/post-review/(?P<book_id>\d+)/$',
                           'bookshelf.views.post_review',
                           name='post_review'),
                       url(r'^bookshelf/save-review/(?P<book_id>\d+)/$',
                           'bookshelf.views.save_review',
                           name='save_review'),
                       url(r'^bookshelf/edit-genre/(?P<genre_id>\d+)/$',
                           'bookshelf.views.edit_genre',
                           name='edit_genre'),
                       url(r'^save-edit-genre/(?P<genre_id>\d+)/$',
                           'bookshelf.views.save_edit_genre',
                           name='save_edit_genre'),
                       url(r'^list-highly-rated-books/$',
                           'bookshelf.views.high_rated_books',
                           name='high_rated_books'),
